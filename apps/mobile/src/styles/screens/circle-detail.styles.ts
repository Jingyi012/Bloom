...
export const circleDetailStyles = StyleSheet.create({
  ...
  heroMetaText: { color: colors.inkSoft, fontSize: 11 },
  ...
  label: { color: colors.inkSoft, fontSize: 12, fontWeight: '800', letterSpacing: 1, marginBottom: spacing.xs, marginTop: spacing.md, textTransform: 'uppercase' },
  ...
  bloomPickerLabel: { color: colors.inkSoft, fontSize: 11 },
