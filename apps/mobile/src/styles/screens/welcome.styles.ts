...
export const welcomeStyles = StyleSheet.create({
  ...
  logo: { height: 136, marginBottom: spacing.xl, width: 136 },
  ...
  note: { color: colors.inkSoft, fontFamily: typography.ui, fontSize: 11, marginTop: spacing.md, textAlign: 'center' },
  error: { color: colors.coralDark, fontFamily: typography.ui, fontSize: 12, marginTop: spacing.md, textAlign: 'center' },
