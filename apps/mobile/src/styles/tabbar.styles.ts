...
export const tabBarStyles = StyleSheet.create({
  bar: { ...shadows.card, alignItems: 'center', backgroundColor: 'rgba(255,249,243,0.96)', borderColor: colors.line, borderRadius: 24, borderWidth: 1, flexDirection: 'row', justifyContent: 'space-around', left: 14, paddingHorizontal: 6, paddingTop: 6, position: 'absolute', right: 14 },
