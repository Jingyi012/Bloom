...
const translations = {
  en: {
    ...
    archivedCirclesSubtitle: "Closed circles remain here for reference.",
    language: "Language",
    ...
    noArchivedCirclesBody: "Circles archived after deletion will appear here.",
    openArchivedCircle: "Open archived circle",
    archivedStatus: "ARCHIVED",
    scheduledBloom: "Scheduled bloom",
    archivedReadOnly: "This circle is archived and is now read-only.",
  ...
  zh: {
    ...
    archivedCirclesSubtitle: "你关闭的圈子会保留在这里，方便日后查看。",
    language: "语言",
    chooseLanguage: "选择语言",
    english: "English",
    chinese: "中文",
    ...
    noArchivedCirclesBody: "删除后被归档的圈子会显示在这里。",
    openArchivedCircle: "打开已归档圈子",
    archivedStatus: "已归档",
    scheduledBloom: "原定开放时间",
    archivedReadOnly: "这个圈子已归档，现在只能查看。",
    calendarTitle: "日记日历",
